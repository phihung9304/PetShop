                ...
                <tbody>
                    @forelse ($guides as $guide)
                        <tr>
                            ...
                            <td>
                                <div class="action-btns"></div><a href="{{ route('care-guides.edit', $guide->id) }}"
                                    class="btn btn-sm btn-warning">
                                    Sửa
                                </a>

                                <form action="{{ route('care-guides.destroy', $guide->id) }}" method="POST"
                                    style="display:inline;">
                                    @csrf
                                    @method('DELETE')

                                    <button class="btn btn-sm btn-danger" onclick="return confirm('Xóa hướng dẫn này?')">
                                        Xóa
                                    </button>
                                </form>
        </div>
